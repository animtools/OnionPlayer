...
![キーフレーム基準（① 基準の切替 ② 一覧 ③ シークバーのマーカー）](images/80_keyframe_basis.png)
...
![書き出し（① 出力の形 ② オプション ③ 枚数と出力サイズ）](images/200_export_modal.png)
...
枚数と出力サイズはダイアログに表示され（図の ③）、進捗の途中で中断できます。
...
ヘッダーの鍵アイコンから **`ライセンス`** を開き、キーを入力して（図の ①）`認証` を押します（図の ②）。
...
![設定（① 秒送り ② コマ送り ③ 音量 ④ リセット）](images/230_settings_modal.png)
